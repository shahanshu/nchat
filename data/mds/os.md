...
**1. Introduction (5 hours)**
    ...
    1.3. Type of Operating System: Batch, Interactive, Multiprocessing, Time
       Sharing and Real Time System
    1.4. Operating System Components
    1.5. Operating System Structure: Monolithic, Layered, Micro‐Kernel,
...
**2. Process Management (6 hours)**
    ...
    2.5. Multiprocessor Scheduling concept
       **3. Process Communication and Synchronization (5 hours)**
          ...
          3.6. Message Passing
          3.7. Monitors
          3.8. Classical Problems of Synchronization: Readers‐Writers Problem,
       ...
       **5. File Systems (6 hours)**
          ...
          5.3. File System Implementation
             ...
             5.3.3. Implementing File: Contiguous Allocation, Link List Allocation,
                Link List Allocation with Table, Inode
          ...
          5.7. Example File Systems: CD ROM file system, MS‐DOS file system, Unix
             File system
...
Unit 7: Deadlock | 5 Hours | (Included in Unit 6/8/9 total)

Unit 8: Security | 4 Hours | 12 Marks (combined with Units 6 & 9)

Unit 9: System Administration | 4 Hours | (Included in Unit 6/8/9 total)
